...
<div class="entity_wrapper">
    ...
    <div class="entity_thumb">
        <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img_top.jpg" alt="feature-top">
    </div>
    <!-- entity_thumb -->
    ...
    <div class="row">
            ...
            <div id="featured-news-carousal" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img9.jpg" alt="Chania">
                    </div>
                    <!--feature_news_item-->
                    <div class="item">
                        <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img13.jpg" alt="Chania">
                    </div>
                    <!--feature_news_item-->
                    <div class="item">
                        <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img14.jpg" alt="Chania">
                    </div>
                    <!--feature_news_item-->
                    <div class="item">
                        <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img15.jpg" alt="Chania">
                    </div>
                    <!--feature_news_item-->
        ...
        <div class="col-md-5">
            <div class="right_category_image">
                <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img10.jpg" alt="feature-top">
            </div>
            <!--carousel-->

            <div class="right_category_image">
                <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img11.jpg" alt="feature-top">
            </div>
            <!--carousel-->
...
<div class="entity_wrapper">
    ...
    <div class="entity_thumb">
        <img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/category_img12.jpg" alt="feature-top">
    </div>
    <!-- entity_thumb -->
...
<div class="entity_wrapper">
    ...
    <div class="entity_content">
        <p class="blockquote">
            ...
            will give you a complete account of the system, and expound the actual teachings.â
        </p>
