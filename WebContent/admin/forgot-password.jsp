      ...
      <div class="card-body">
        ...
        <%
			if(request.getParameter("msg")!=null){
				...
				switch(msg){
				case 0:
					out.print("<h5 style='font-style: italic; color:red;text-align:center'>Bạn cần nhập đủ các trường yêu cầu theo đúng định dạng</h5>");break;
				case 1:
					out.print("<h5 style='font-style: italic; color:green;text-align:center'>Bạn đã gửi thành công</h5>");break;
				default: out.print("<h5 style='font-style: italic; color:red;text-align:center'>Có lỗi trong quá trình xử lý</h5>");break;
					
				}
			}
		%>
        <form action="<%=request.getContextPath()%>/admin/forgot" method="post">
        ...
        <div class="text-center">
          <a class="d-block small" href="<%=request.getContextPath()%>/admin/login">Login Page</a>
        </div>
      </div>
    </div>
  </div>
